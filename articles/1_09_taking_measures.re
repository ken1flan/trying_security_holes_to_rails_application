...
== @<href>{https://github.com/presidentbeef/brakeman,Brakeman}


Railsのための、セキュリティ脆弱性を検知する静的コード解析ツールがあります。
アプリケーションのルートディレクトリで@<tt>{brakeman}と実行するだけで、コード全体をチェックしてくれます。
...
=== @<href>{https://github.com/rubocop-hq/rubocop,rubocop}
...
=== @<href>{https://github.com/troessner/reek,reek}
...
=== @<href>{https://github.com/flyerhzm/rails_best_practices,railsbestpractices}


@<href>{https://rails-bestpractices.com/,railsbestpractices}でよいとされている書き方から外れていないかチェックするツールです。


=== @<href>{https://github.com/client9/misspell/,misspell}
 ...
 * @<href>{https://sider.review/ja,cider}
 * @<href>{https://houndci.com/,houndci}
